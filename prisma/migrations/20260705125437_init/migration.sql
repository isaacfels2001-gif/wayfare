...
CREATE TABLE "FareOption" (
    ...
    CONSTRAINT "FareOption_flightId_fkey" FOREIGN KEY ("flightId") REFERENCES "Flight" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "TourDeparture" (
    ...
    "seatsAvailable" INTEGER NOT NULL,
    CONSTRAINT "TourDeparture_tourId_fkey" FOREIGN KEY ("tourId") REFERENCES "TourPackage" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
